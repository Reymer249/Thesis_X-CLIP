...
y_neg_20 = [98.9, 42.3, 94.4, 7.6, 0]
y_pos_20 = [100, 0.6, 20.3, 0.1, 0]

y_neg_100 = [100, 55.4, 97.8, 21.0, 0]
y_pos_40 = [99.9, 41.0, 97.1, 16.0, 0]

y_neg_5 = [89.6, 23.0, 82.3, 2.6, 0]
y_pos_5 = [100, 0, 0.6, 0, 0]

y_neg = y_neg_20_proper_distribution
y_pos = y_pos_20_proper_distribution
...
fig.add_trace(go.Bar(
    x=x,
    y=y_neg,
    name='Hard Negatives<br>(Set Size 20)',
...
fig.add_trace(go.Bar(
    x=x,
    y=y_pos,
    name='Hard Positives<br>(Set Size 20)',
